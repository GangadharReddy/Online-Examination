...
public class AQuesucdc extends HttpServlet
{
   public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
   {
        ...
        try
        {
                ...
                out.println("<br><a href=\"http://localhost:1234/servlet/AQuesd.class\">Back..</a></font></body>");
                st.close();
                c.close();
        }
        catch(Exception e)
...
public class AQuesucdc extends HttpServlet
{
   ...
   throws ServletException,IOException
   {
        ...
        try
        {
                ...
                int i=st.executeUpdate("delete from mquestions where (lang='" + lan +"' and questype='" + type + "' and quesno=" + val + ")");

                out.println("<body background='http://localhost:1234/paper_bg.gif'>");
                out.println("<font size=4 color=blue><b><center>");
                out.println("Record deleted Sucessfully");
                out.println("<a href='http://localhost:1234/servlet/AQuesd.class'>");
