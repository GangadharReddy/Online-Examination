...
public class Qadd extends HttpServlet
{
   public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
   {
        ...
        try
        {
                ...
                out.println("<html><body background='http://localhost:1234/paper_bg.gif'><font size=4 color=blue><b><center>");
                out.println("<br><br>Record inserted Successfully");
                out.println("<a href='http://localhost:1234/atquestions.html'>Back..</a>");
