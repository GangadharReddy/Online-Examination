...
public class Subjects extends HttpServlet
{
   ...
   throws ServletException,IOException
   {
        ...
        try
        {
                ...
                out.println("<html><body background='http://localhost:1234/paper_bg.gif'>");
                ...
                out.println("<a href=http://localhost:1234/servlet/QD>next..</a>");
                out.println("<a href=http://localhost:1234/instr.html>back..</a>");
