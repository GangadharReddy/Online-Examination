...
{       
     ...
     throws ServletException,IOException
     {
          ...
          try
          {
               ...
               out.println("<body background='http://localhost:1234/paper_bg.gif'>");
               out.println("<form action=http://localhost:1234/regusers.html>");
               ...
               {
                        out.println("<body background='http://localhost:1234/paper_bg.gif'><font size=4 color=red> Sorry!. An User with " + user + " is already existing.Please Choose another login ID.");
                        out.println("<br><a href='http://localhost:1234/newusers.html'>Back..</a>");
