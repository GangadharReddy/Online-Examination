...
public class AQuesdc extends HttpServlet
{
     public void service(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
     {
          ...
          try
          {
                ...
                out.println("{");
                out.println("window.location.href=\"http://localhost:1234/servlet/AQuesd\";");
                out.println("}");
                out.println("</script></head>");
                out.println("<body bgcolor=lightyellow background=paper_bg.gif><form method=post action=\"http://localhost:1234/servlet/AQuesucd.class\">");
...
public class AQuesdc extends HttpServlet
{
     ...
     throws ServletException,IOException
     {
          ...
          try
          {
                ...
                out.println("<form method=post action='http://localhost:1234/servlet/AQuesucd'>");
