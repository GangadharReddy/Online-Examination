...
public class AUsersd extends HttpServlet
{
   ...
   public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
   {
        ...
        try
        {
                ...
                out.println("<body background=http://localhost:1234/paper_bg.gif text=blue >");
                ...
                out.println("<a href=http://localhost:1234/servlet/AUD>Next..</a>  <a href=http://localhost:1234/ausersd.html>Back..</a>");
                out.println("</body>");
                rs.close();
                st.close();
                c.close();
