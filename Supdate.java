...
public class Supdate extends HttpServlet
{
   ...
   { 
        ...
        try
        {
                ...
                out.println("<html><body background='http://localhost:1234/paper_bg.gif'><font size=4 color=blue><b>");
                out.println("Record Updated Sucessfully");
                out.println("<a href=\"http://localhost:1234/atsubjects.html\">Back..</a></b></font></body></html>");
                st.close();
                c.close();
        }
        catch(Exception e)
